...
without retraining, and the threshold experiment above can be reproduced from
the released scores alone. Leave-one-out figures from our earlier experiments
appear once, in Table~\ref{tab:loocv}, explicitly marked as single unseeded
runs.
