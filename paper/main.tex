...
configuration, including one built on a large-scale chest-radiograph
foundation model, and does not move even under a manipulation that halves
overall performance. Applied unchanged to 1{,}426 VinDr-CXR images, the detector reaches
