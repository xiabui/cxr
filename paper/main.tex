...
\author{B\`ui V\u{a}n X\'ia \and Tr\`{\^a}n Th\d{\i} Qu\`ynh Nga}
\date{}
...
We do not claim novelty for subtlety-stratified evaluation, which
Horry~et~al.~\cite{horry2023fullres} performed on this dataset, nor for the
observation that frozen foundation features suppress small-lesion signal, which
Muthyala~et~al.~\cite{muthyala2026frozen} report independently. Our
...
Applied unchanged to 1{,}426 VinDr-CXR images with 1{,}795 nodules, the same
detector reaches a CPM of 16.5\% $[14.7, 18.3]$ under a match tolerance more
generous than the internal one --- against 43.3\% internally. Careful internal
uncertainty quantification did not anticipate that gap.
